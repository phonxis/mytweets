...
class RegisterForm(forms.Form):
    ...
    password = forms.CharField(widget=forms.PasswordInput(attrs={'size': 32, 'placeholder': 'Enter Password', 'class':'form-control'}))
    confirm_password = forms.CharField(widget=forms.PasswordInput(attrs={'size': 32, 'placeholder': 'Confirm Password', 'class':'form-control'}))
    q = forms.PasswordInput
    def clean(self):
